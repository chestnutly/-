...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "mask_rcnn_shapes_0050.h5")
...
class DrugDataset(utils.Dataset):
    ...
    def draw_mask(self, num_obj, mask, image, image_id):
        ...
        for index in range(num_obj):
            mask[:, :, index] = np.where(np_image == index + 1, 1, 0)
        # for index in range(num_obj):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        """
        # Add classes
        self.add_class("shapes", 1, "huaheng")
        #self.add_class("shapes", 2, "pengao")
        #self.add_class("shapes", 3, "tufeng")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("huaheng")!= -1:
                # print "car"
                labels_form.append("huaheng")
            #elif labels[i].find("pengao") != -1:
                # print "leg"
             #   labels_form.append("pengao")
            #elif labels[i].find("tufeng") != -1:
                # print "well"
             #   labels_form.append("tufeng")
...
# 基础设置
dataset_root_path = "samples/mydata/"
